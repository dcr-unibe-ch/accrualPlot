...
`r badger::badge_custom("dev version", as.character(packageVersion("accrualPlot")), "blue", "https://github.com/dcr-unibe-ch/accrualPlot")`
[![Actions Status](https://github.com/dcr-unibe-ch/accrualPlot/workflows/R-CMD-check/badge.svg)](https://github.com/dcr-unibe-ch/accrualPlot/actions)
...
The development version of the package can be installed from the DCR universe via
